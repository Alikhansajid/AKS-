...
//     // Flexible selectors to handle PriceOye's potential HTML changes
...
//   link: string;
//   slug: string;
//   sourceUrl?: string; // Added to match schema
//   details?: { url: string }; // Added to match schema
// }
...
//         link, 
//         slug,
//         sourceUrl: link, // Set sourceUrl to link
//         details: link ? { url: link } : undefined // Set details to link if available
//       });
//     });
...
//                 price: prod.price,
//                 categoryId,
//                 isfetch: true, // Set isfetch to true for updated products
...
//                 quantity: 0,
//                 categoryId,
//                 isfetch: true, // Set isfetch to true for newly created products
//                 sourceUrl: prod.sourceUrl,
//                 details: prod.details,
//                 images: prod.img ? { create: [{ url: prod.img }] } : undefined,
//               },
