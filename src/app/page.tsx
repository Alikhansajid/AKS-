...
export default function Home() {
  ...
  if (isLoading) return <div className="p-6 text-center text-violet-600">Loading products...</div>;
    ...
    <div className="bg-gray-50 min-h-screen font-sans text-gray-900">
      ...
      >
        ...
        <div className="flex gap-3">
          <a
            href="#products"
            className="bg-amber-500 hover:bg-amber-600 text-white px-6 py-3 rounded-full font-semibold transition-shadow shadow-md"
          >
            Browse Products
          </a>
          <Link href="/collections" className="px-6 py-3 rounded-full border border-white/30 hover:bg-white/10 transition">
